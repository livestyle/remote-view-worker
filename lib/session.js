...
module.exports = class Session extends EventEmitter {
	...
	set liveStyleTunnel(socket) {
		if (this._liveStyleTunnel) {
			this._liveStyleTunnel.destroy();
		}

		var self = this;
		var onData = onLiveStyleSocketData.bind(this);
