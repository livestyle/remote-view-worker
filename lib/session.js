...
module.exports = class Session extends EventEmitter {
	...
	addSocket(socket) {
		...
		var self = this;
		// TODO use 'end' instead of `close' in case if server
		// did not handled 'connection: close' properly
	...
	addToQueue(req, res) {
		...
		debug('add to queue, %d of %d', this._queue.length, this.options.maxQueue);
